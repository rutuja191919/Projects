...
Color c;
	public ATReport()
	{
		...
		back.setBounds(50,40,140,30);
  		b.setBounds(510,140,170,32);
		stud.setBounds(510,190,170,32);
		...
		lb.setBounds(140,140,200,30);
		ls.setBounds(140,190,200,30);
...
e.printStackTrace();
		...
		bid=new JTextField();
		sid=new JTextField();
		bid.setBounds(310,140,105,30);
		background.add(bid);
		sid.setBounds(310,190,105,30);
		background.add(sid);
