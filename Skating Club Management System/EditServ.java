...
Color c=new Color(255,0,0);
	...
	try
	{
	s.rs=s.stmt.executeQuery("select sr.sid,fname,mname,lname,contact,sdate,nsdate,type from student,sr where student.sid="+s.sid+" and 	sr.sid="+s.sid);
		while(s.rs.next())
		{	
...
id1.setFont(f);
    ...
    nam.setBounds(450,140,200,30);
    id1.setBounds(450,180,200,30);
    cono.setBounds(450,220,200,30);
    tp.setBounds(450,260,200,30);
    dt1.setBounds(450,300,160,30);
    dt2.setBounds(450,340,160,30);
   
    update.setBounds(460,490,160,33);
