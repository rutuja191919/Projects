...
public class MainScreen extends JFrame implements ActionListener
{
	...
	public MainScreen ()
  {
   ...
   lab2=new JLabel("SKATING ACADAMY!!!");
	...
	btnClose = new JButton ("CLOSE",new ImageIcon (ClassLoader.getSystemResource ("pics/exit.png")));
    btnLogin= new JButton ("",new ImageIcon (ClassLoader.getSystemResource ("pics/lgin.png")));
...
lab2.setBounds (378, 140, 820, 55);
  ...
  lab2.setFont(f);
    ...
    btnLogin.setBounds (930, 380 ,180, 70);
    btnClose.setBounds (930, 490, 180, 45);

  	JLabel background=new JLabel(new ImageIcon(ClassLoader.getSystemResource ("pics/main1.png")));
  	this.add(background);
